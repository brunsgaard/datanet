...
\begin{description}
    \item[Part 1:] Modern TCP implementation employ congestion control based on perceived network
        congestion. This is not network assisted, and works by measuring the ACK that are received
        to detect possible losses as a result of congestion. The traffic is then appropriately throttled.
    \item[Part 2:] %TODO: Write me!
