...
\begin{description}
    ...
    \item[Part 3:] When the connection is being established the congestion
        ...
        If a timeout occurs the congestion window is halfed. After this point,
        the congestion window is increased by one segment, per segment that
        are acknowledged by the sender in the transmission.
